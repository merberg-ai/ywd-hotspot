...
class H(BaseHTTPRequestHandler):
    server_version = "YWD-Hotspot-Setup/0.6"
...
<section class="step" data-step="8"><h2>Setup complete</h2><p id="doneText">Configuration has been applied.</p><p id="dashText">The dashboard is now available at:</p><p><a id="dashLink" class="dashboard-link" href="http://ywd-hotspot.local:8080/">http://ywd-hotspot.local:8080/</a></p><p id="redirectText" class="hint"></p></section>
</div></main><script>
