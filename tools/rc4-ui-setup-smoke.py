...
dashboard_update = text("lib/dashboard_update.py")
...
require(dashboard_update, 'self.send_header("Location", "http://ywd-hotspot.local:8443/")', "dashboard first-run redirect")
reject(dashboard_update, 'self.send_header("Location", "https://ywd-hotspot.local:8443/")', "dashboard first-run redirect")
print("[OK] first-boot setup, restore, dashboard redirect, and factory image are HTTP-only without a self-signed TLS gate")
...
require(dashboard_update, 'get("loading_animation", "digital_waterfall")', "first-paint startup default")
